    ...
    onmessage = function (event)
    {
        ...
        switch (eventData.command)
        {
            ...
            case "InputData":
                ...
                //console.log("DecodeWorker-InputData-len:"+iLen +",nSysTime:"+ new Date().Format("MM-dd hh:mm:ss.S") );
                //console.log("DecodeWorker-InputData 1 sysTime:"+ (new Date().getMonth()+1) + "-" + new Date().getDate() + " " + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + "." + new Date().getMilliseconds()+",iLen:"+iLen);
                ...
                if (iLen > 0)
                {
                    ...
                    //console.log("DecodeWorker-InputData-ret 2 sysTime:"+ (new Date().getMonth()+1) + "-" + new Date().getDate() + " " + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + "." + new Date().getMilliseconds()+",res:"+res);
                    if (res !== HK_TRUE)
                    {
                        if (res === 98)
                        {
                ...
                {
                    //console.log("DecodeWorker-InputData-getFrameData 3-1 sysTime:"+ (new Date().getMonth()+1) + "-" + new Date().getDate() + " " + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + "." + new Date().getMilliseconds());
                    var ret = getFrameData(funGetFrameData);
                    //console.log("DecodeWorker-InputData-getFrameData 3-2 sysTime:"+ (new Date().getMonth()+1) + "-" + new Date().getDate() + " " + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + "." + new Date().getMilliseconds()+",ret:"+ret);
        ...
        if (res === HK_TRUE)
        {
            ...
            switch (oFrameInfo.frameType)
            {
                case AUDIO_TYPE:
                    ...
                    //console.log("js getFrameData Audio sysTime:%d, nSise:%d , nSampleRate:%d",new Date().getTime(), oFrameInfo.frameSize, oFrameInfo.samplesPerSec);
                    //console.log("DecodeWorker-InputData-getFrameData Audio sysTime:"+(new Date().getMonth()+1) + "-" + new Date().getDate() + " " + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + "." + new Date().getMilliseconds()+",nSise:"+ oFrameInfo.frameSize+",nSampleRate:"+oFrameInfo.samplesPerSec);
                    postMessage({
                ...
                case VIDEO_TYPE:
                    ...
                    //console.log("js getFrameData video sysTime:%d, nWidth:%d,nHeight:%d",new Date().getTime(), rameInfo.width, oFrameInfo.height);
                    //console.log("DecodeWorker-InputData-getFrameData Video sysTime:"+(new Date().getMonth()+1) + "-" + new Date().getDate() + " " + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + "." + new Date().getMilliseconds()+",nWidth:"+ rameInfo.width+",nHeight:"+oFrameInfo.height);
                    postMessage({
