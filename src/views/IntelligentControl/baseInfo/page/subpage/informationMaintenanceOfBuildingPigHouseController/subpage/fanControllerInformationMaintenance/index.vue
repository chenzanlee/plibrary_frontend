<template>
  <div class="home el-delogBG2 fanControllerInformationMaintenance">
    <!-- 头部导航 -->
    ...
    >
      ...
      <div slot="footer" class="dialog-footer label90">
...
const slotList = [{ value: 1 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }, { value: 6 }, { value: 7 }]
...
import {
  ...
  unreview,
  review
} from '@/http/api/baseInfo/fanControllerInformationMaintenance.js'
export default {
  components: {
    tablePage,
    navForm,
            ...
            inpLists: [
              {
                ...
                innerText: '新增',
                className: 'btn-blue',
                authCode: 'roofSubControllerMaintain:btn_add',
                handleClick: () => {
                  this.status = 1
                  this.resetGenerForm()
              ...
              },
              {
                ...
                isDisabled: true,
                authCode: 'roofSubControllerMaintain:btn_review',
                handleClick: () => {
              ...
              },
              {
                ...
                className: 'btn-blue-disabled',
                isDisabled: true,
                authCode: 'roofSubControllerMaintain:btn_unreview',
                handleClick: () => {
                  if (this.unAuditarr.length !== 0) {
            ...
            btnLists: [
              {
                innerText: '查询',
                className: 'btn-blue',
                authCode: 'roofSubControllerMaintain:list',
                handleClick: () => {
        ...
        },
        {
          ...
          group: [
            ...
            },
            {
              name: '修改',
              class: 'btn-blue',
              authCode: 'roofSubControllerMaintain:btn_update',
              size: 'auto',
              click: 'edit',
              status: 'NORMAL'
            },
            {
              name: '删除',
              class: 'btn-red',
              authCode: 'roofSubControllerMaintain:btn_del',
              size: 'auto',
              click: 'remove',
              status: 'NORMAL'
            }
      ...
      formInfo: {
        ...
        fieldList: [
          ...
          },
          {
            ...
            list: 'BlockList',
            required: true,
            rules: [{ required: true, message: '请选择座号', trigger: 'change' }],
            handleChange: (data) => {
            }
          },
          {
            ...
            list: 'slotList',
            required: true,
            rules: [{ required: true, message: '请选择编号', trigger: 'change' }],
            handleChange: (data) => {
            }
          },
          {
  ...
  methods: {
    ...
    determine() {
      ...
      if (this.status === 1) {
        const { slot, block, regionName, areaName, fieldName, deviceId, deviceName, deviceVersionId, deviceVersionName, equipmentId, equiptypeId, equiptypeName, qrCode } = this.formInfo.data
        const o = {
...
.fanControllerInformationMaintenance{
