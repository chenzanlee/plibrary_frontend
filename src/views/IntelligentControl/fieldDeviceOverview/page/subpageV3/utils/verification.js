...
class RulesService {
  ...
  limit_mac_address_v3 = { rules: this.rulesMacAddressV3 }
  // 设备控制
  ...
  limit_0_2 = { rules: this.rulesLimit(0, 2) }
  limit_5_100 = { rules: this.rulesLimit(5, 100) }
  limit_0_5 = { rules: this.rulesLimit(0, 5) }
  limit_1_10 = { rules: this.rulesLimit(1, 10) }
  limit_0_3 = { rules: this.rulesLimit(0, 3) }
  limit_10_3600 = { rules: this.rulesLimit(10, 3600) }
  limit_20_35 = { rules: this.rulesLimit(20, 35) }
  limit_20_32 = { rules: this.rulesLimit(20, 32) }
  limit__10_10 = { rules: this.rulesLimit(-10, 10) }
  limit_3_60 = { rules: this.rulesLimit(3, 60) }
  limit_2_60 = { rules: this.rulesLimit(2, 60) }
  limit_3_120 = { rules: this.rulesLimit(3, 120) }
  // limit_20_35 = { min: 20, max: 35, rules: this.rulesLimit(10, 60) }
  macAdress(address) {
