<template>
  <div class="home fanDatabase">
    ...
    <div class="orderHistory">
      ...
      <nav-form ref="navForm" class="orderHistory-navForm" :data="navFormInfo.data" :field-list="navFormInfo.fieldList" />
    </div>
...
export default {
  ...
  beforeRouteLeave(to, form, next) {
    if (to.name !== 'intelligentControlOverview') {
  ...
  methods: {
    ...
    // 获取表单信息  请求
    getMyEvcMcuInfo() {
      console.log(this.navFormInfo.data)
