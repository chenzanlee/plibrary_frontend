<template>
  <div class="overview-box OverviewBox">
    <el-form
      ref="overviewBoxForm"
      :model="data"
      :rules="rules"
...
.default-class {
  border-radius: 18px;
  background: #122053;
  @include background_color('overviewBoxDefaultBkColor');
  @include font_color('overviewBoxDefaultFontColor');
}
.selected-class {
  color: #ffffff;
  @include font_color('overviewBoxSelectFontColor');
  background-color: #10aeff;
  @include background_color('overviewBoxSelectBkColor');
}
.overview-box {
  border-radius: 4px;
  // background: #27376f;
