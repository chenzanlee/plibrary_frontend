<template>
  <div class="sortbg">
    ...
    <div class="main-contain overfolw">
      ...
      <div v-for="(item,index) in resData" :key="index">
        <div :class="[ item.percenter < 50 ? 'list-container list-container-red' : 'list-container']">
          <div class="list-index">{{ index + 1 }}</div>
          <div class="list-name">{{ item.name }}</div>
          <div class="list-data">{{ item.data1 !== undefined ? item.data1 : 100 }}/{{ item.data2 !== undefined ? item.data2 : 100 }}</div>
          <div class="list-percentage">{{ item.percenter }}%</div>
        </div>
      </div>
    </div>
  </div>
