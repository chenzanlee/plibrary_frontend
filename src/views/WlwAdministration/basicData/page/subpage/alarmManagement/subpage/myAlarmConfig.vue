...
export default {
        ...
        },
        {
          ...
          group: [
            ...
            },
            {
              name: '修改',
              class: 'btn-blue',
              authCode: 'myAlarmConfig:btn_edit',
              size: 'auto',
              click: 'edit',
              status: 'NORMAL'
            },
            {
              name: '删除',
              class: 'btn-red',
              authCode: 'myAlarmConfig:btn_del',
              size: 'auto',
              click: 'remove',
              status: 'NORMAL'
            }
            ...
            inpLists: [
              {
                type: 'button',
                innerText: '新增',
                authCode: 'myAlarmConfig:btn_add',
                className: 'btn-blue',
                handleClick: () => {
                  this.status = 1
              ...
              },
              {
                type: 'button',
                innerText: '审核',
                authCode: 'myAlarmConfig:btn_review',
                isDisabled: true,
                className: 'btn-blue',
                handleClick: () => {
              ...
              },
              {
                type: 'button',
                innerText: '反审核',
                authCode: 'myAlarmConfig:btn_unreview',
                isDisabled: true,
                className: 'btn-blue',
                handleClick: () => {
                  if (this.unAuditarr.length !== 0) {
  ...
  created() {
    this.pageElement = getConfigElement('myAlarmConfig')
