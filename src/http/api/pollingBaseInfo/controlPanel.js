...
export function review(data) {
  const url = '/api/bar_patrol/myBpCarConfig/review?ids=' + data.ids
...
export function unreview(data) {
  const url = '/api/bar_patrol/myBpCarConfig/unreview?ids=' + data.ids
...
export function myEvcMcuInfoAdd(data) {
  return request('/api/bar_patrol/myBpCarConfig/add', {
    method: 'post',
    data: data
  })
}
...
export function myEvcMcuInfoUpdate(data) {
  return request('/api/bar_patrol/myBpCarConfig/update', {
    method: 'put',
    data: data
  })
}
...
export function myEvcMcuInfoDelete(data) {
  const url = '/api/bar_patrol/myBpCarConfig/delete?ids=' + data.ids
  return request(url, {
    method: 'delete',
    data: data
  })
